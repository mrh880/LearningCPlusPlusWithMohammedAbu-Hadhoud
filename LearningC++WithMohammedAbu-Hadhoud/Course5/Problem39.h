...
void Print()
{
    ...
    CopyArrayWithPrimeNumbers(OriginalArray, SizeOfOriginalArray, CopyArray, SizeOfCopyArray);
    PrintArrayData(CopyArray, SizeOfCopyArray, "Copy Array with prime numbers");
}