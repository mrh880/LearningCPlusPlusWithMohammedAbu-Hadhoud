...
void Print()
{
    ...
    string Sentence = ReadText::ReadTextOnScreen("Enter a sentence to make all first letter of each word capital: ");
    PrintingText::PrintSequenceOfCharacters('*', 158);
    PrintingText::PrintLines();

    PrintingText::PrintSequenceOfCharacters('*', 100);
    PrintingText::PrintLines();
    PrintingText::PrintTextOnScreen("Your sentence after make every letter capital: ");
    StringsOperations::MakeEveryFirstLetterOfEachWordCapital(Sentence);
