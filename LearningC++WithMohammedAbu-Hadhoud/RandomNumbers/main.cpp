...
// {
//     long long Random = rand() % (To - From + 1) + From;
...
// void PrintRandomNumbers(int Number)
// {
//     PrintingAline(40);
//     cout << "These are your random number !\n";
//     PrintingAline(40);

//     PrintingAline(60);
//     for(int loop = 0; loop < Number; loop++)
//     {
//         cout << "Key [" << loop << "]: " << RandomNumber(100, 50);
//     }
//     PrintingAline(60);
// }
...
// {
//     PrintingAline(60);
//     cout << "You want to get random numbers let's do it now ! \n";
//     PrintingAline(60);
// }
...
//     GreetingMessage();
//     PrintingAline(40);
//     PrintRandomNumbers(ReadPositiveNumber("Enter how many random number you want: "));
//     PrintingAline(40);
...
string GenerateWord(enCharacterType, short LengthOfWord)
{
    ...
    {
        Word += GetRandomCharacter(enCharacterType::Digit);
    }
    return Word;
}
...
string GenerateKey(short LengthOfKey, short LengthOfWord)
{
    ...
    for(short loop = 1; loop <= LengthOfKey; loop++)
    {
        if(loop != LengthOfKey)
        {
            Key += GenerateWord(enCharacterType::Digit, LengthOfWord);
            Key += '-';
        }
        else
            Key += GenerateWord(enCharacterType::Digit, LengthOfWord);
